...
#         _ 0                                               , 1                                   , 2                     , 3                     , 4     , 5           , 6                                                        , 7                 , 8
		self.EMCConfig = [	
			...
			(  _("Show EMC Bookmarks in movielist")               , config.EMC.bookmarks_emc            , None                  , None                  , 0     , []          , _("HELP_Show EMC Bookmarks in movielist")                , None              , True ),
			...
			(  _("Show TV, Preview or Cover")                     , config.EMC.movie_pig                , None                  , None                  , 0     , []          , _("HELP_Show Show TV, Preview or Cover")                 , "TV"              , None ),
			(  _("Preview / cover delay in ms")                   , config.EMC.movie_pig_delay          , None                  , None                  , 0     , [-1]        , _("HELP_Preview cover delay in ms")                      , 2000              , None ),
