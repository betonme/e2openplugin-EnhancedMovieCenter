...
#		self["key_blue"] = Button(" ")
		...
		self.list.append(getConfigListEntry(_("Show Latest Recordings directory"), config.EMC.latest_recordings, None, None))
		self.list.append(getConfigListEntry(_("Show VLC directory"), config.EMC.vlc, None, None))
		self.list.append(getConfigListEntry(_("Show E2 Bookmarks"), config.EMC.e2bookmarks, None, None))
		#self.list.append(getConfigListEntry(_("Show EMC Bookmarks"), config.EMC.emcbookmarks, None, None))
		#self.list.append(getConfigListEntry(_("Hide all links (files and folders)"), config.EMC.links_hide, None, None))
