...
#         _ 0                                               , 1                                   , 2                     , 3                     , 4     , 5           , 6                                                        , 7                 , 8
		self.EMCConfig = [	
			...
			(  _("Show Directories within the movielist")         , config.EMC.directories_ontop        , None                  , None                  , 0     , [-2]        , _("HELP_Show Directories within the movielist")          , False             , True ),
			...
			(  _("Cutlist.at offset in seconds")                  , config.EMC.cutlist_at_offset        , None                  , None                  , 1     , [-1]        , _("HELP_Cutlist.at offset")                       , None              , None ),
