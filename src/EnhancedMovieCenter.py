...
#			(  _("Show symlinkdirectories_information")           , config.EMC.symlinkdir_info          , None                  , None                  , 0     , [-1]        , _("HELP_Show symlink_directories_information")           , False             , True ),
			...
			(  _("Never scan size of dirs from emc-noscan.cfg")   , config.EMC.dir_info_usenoscan       , None                  , None                  , 0     , [-1]        , _("HELP_Never scan size of dirs from emc-noscan.cfg")    , None              , False ),
