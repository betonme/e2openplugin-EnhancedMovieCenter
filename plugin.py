...
config.EMC.e2bookmarks = ConfigYesNo(default = True)
config.EMC.emcbookmarks = ConfigYesNo(default = True)
config.EMC.hide_linkedfiles = ConfigYesNo(default = False)
config.EMC.hide_linkedfolders = ConfigYesNo(default = False)
